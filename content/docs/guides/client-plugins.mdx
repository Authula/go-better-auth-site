...
The EmailPassword plugin provides convenience methods to make requests to the API endpoints on the Authula server. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/email-password/).

### OAuth2

The OAuth2 plugin provides convenience methods to make requests to the API endpoints on the Authula server. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/oauth2/).

### CSRF

The CSRF plugin automatically handles CSRF tokens for mutating requests. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/csrf/).

### JWT

The JWT plugin provides convenience methods to make requests to the API endpoints on the Authula server. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/jwt/).

### Bearer

The Bearer plugin automatically adds authorization headers and handles token refresh. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/bearer/).

### Magic Link

The Magic Link plugin provides convenience methods to handle magic link authentication flows. View the [Source Code](https://github.com/Authula/authula-node-sdk/blob/main/src/plugins/magic-link/).
