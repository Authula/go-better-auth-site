...
You can view the full config here: [Source Code](https://github.com/Authula/authula/blob/main/models/config.go)

You can view the configs of each plugin within their respective folders in the [plugins directory](https://github.com/Authula/authula/tree/main/plugins).
